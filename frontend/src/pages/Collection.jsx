...
const Collection = () => {
  ...
  const applyFilter = () => {
    let productsCopy = products.slice() //create copy of entire product array
 ...
 const sortProduct = () => {
    let filterProductCopy = filterProducts.slice(); //copy of all filter products
